...
const ATELIER_SELECTED = {
    selected: 'border-primary/50 bg-primary/10 shadow-none',
    check: 'text-primary',
};
                        ...
                        {group.models.map((model) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className="text-sm text-text-secondary mt-0.5 leading-relaxed">
                                        {model.description}
                                    </span>
                                        ...
                                        <div className="flex gap-1 mt-1.5">
                                            {model.badges.map((badge) => (
                                                <span
                                                    key={badge}
                                                    className={
                                                        badge === '推荐' || badge === 'Recommended'
                                                            ? 'recommendation-badge'
                                                            : 'text-sm px-1.5 py-0.5 rounded bg-elevated text-text-secondary'
                                                    }
                                                >
                                                    {badge}
                                                </span>
