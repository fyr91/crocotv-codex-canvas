                ...
                >
                    ...
                    <div className="flex items-center justify-between p-5 border-b border-glass-border">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl font-medium text-foreground">{t("genSettings")}</h2>
                                <p className="text-sm text-text-muted">{t("genSettingsDesc")}</p>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <div className="p-5 space-y-6 overflow-y-auto">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    {ASPECT_RATIOS.map((ratio) => (
                                        ...
                                        >
                                            <span className="text-sm font-medium text-foreground">{ratio.name}</span>
                                            <span className="text-sm text-text-muted">{ratio.description}</span>
                                        </button>
                                    ))}
                                </div>
                            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-sm text-text-muted">{t("motionFollowsAR")}</p>
                    ...
                    <div className="flex justify-end gap-3 p-5 border-t border-glass-border bg-surface">
                        ...
                        <button
                            onClick={handleSave}
                            disabled={isSaving}
                            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary to-primary hover:from-primary hover:to-primary text-white text-sm font-medium rounded-lg transition-all disabled:opacity-50"
                        >
                            {isSaving ? (
                                <>
