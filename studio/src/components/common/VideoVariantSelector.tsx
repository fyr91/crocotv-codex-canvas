            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 bg-elevated rounded-lg p-1 border border-glass-border">
                        <span className="text-sm text-text-secondary px-2">{t("duration")}:</span>
                        {[5].map(d => (
                            <button
                                key={d}
                                onClick={() => setDuration(d)}
                                className={`px-3 py-1 text-sm font-medium rounded-md transition-colors ${duration === d
                                ...
                                return (
                                    <div
                                        ...
                                        className={`
                                            ...
                                            ${isSelected ? 'border-primary ring-2 ring-primary/30' : 'border-transparent hover:border-glass-border'}
                                        `}
                                    ...
                                    >
                                        ...
                                        <div className="absolute inset-0 flex items-center justify-center">
                                            {video.status === 'processing' || video.status === 'pending' ? (
                                                ...
                                                <X size={16} className="text-status-failed-fg" />
                                            ) : (
