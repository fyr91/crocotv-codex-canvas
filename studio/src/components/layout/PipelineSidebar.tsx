                ...
                {steps.map((step, index) => {
                    ...
                    return (
                        <button
                            ...
                            className={clsx(
                                "w-full relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group overflow-hidden",
                                isActive
                        ...
                        >
                            ...
                            <div className="flex flex-col items-start gap-0.5 text-sm flex-1 min-w-0">
                                <div className="flex items-center gap-2">
                                    ...
                                    {step.comingSoon && (
                                        <span className="text-sm px-1.5 py-0.5 rounded-full bg-accent/20 text-accent border border-accent/30 font-medium">
                                            {tp("beta")}
                                        </span>
                                    )}
                                </div>
                            ...
                            {isActive ? (
                                ...
                                <span
                                    ...
                                    className={clsx(
                                        ...
                                        step.status === "warn" && "bg-accent shadow-none",
            ...
            <div className="p-4 border-t border-glass-border">
                <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-glass border border-border-subtle">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-sm text-text-muted">{projectSubLabel ?? "v0.1.0"}</span>
                    </div>
                </div>
            </div>
        </motion.aside>
