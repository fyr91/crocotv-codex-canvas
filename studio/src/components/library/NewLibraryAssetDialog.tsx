      ...
      >
        ...
        <div className="flex items-start justify-between gap-3 px-5 pt-5 pb-3 border-b border-glass-border">
          <div>
            ...
            <div className="text-sm text-text-muted mt-0.5">{t("newAssetSubtitle")}</div>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="px-5 py-4 flex flex-col gap-4">
          {/* 类型选择 */}
          <div>
            <span className="font-mono text-sm font-medium uppercase tracking-[0.1em] text-text-secondary">
              {t("assetTypeAria")}
            </span>
            <div
          ...
          <div>
            <label
              ...
              className="font-mono text-sm font-medium uppercase tracking-[0.1em] text-text-secondary"
            >
              {t("nameLabel")}
            </label>
            <input
              ...
              className="mt-2 w-full bg-surface-inset border border-glass-border rounded-lg px-3.5 py-2.5 text-sm text-foreground placeholder-text-muted focus:outline-none focus:border-primary/60"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="mt-2 w-full bg-surface-inset border border-glass-border rounded-lg px-3.5 py-2.5 text-sm text-foreground placeholder-text-muted focus:outline-none focus:border-primary/60 resize-none"
            />
          </div>
          ...
          <div>
            ...
            <div className="mt-2 flex items-center gap-3">
              ...
              <button
                ...
                disabled={uploading}
                className="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg bg-surface-inset border border-glass-border text-text-secondary text-sm font-medium hover:text-foreground transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
              >
            ...
            <label
              ...
              className="block mt-3 font-mono text-sm font-medium uppercase tracking-[0.1em] text-text-secondary"
            >
              {t("imageUrlLabel")}
            </label>
            <input
              ...
              className="mt-2 w-full bg-surface-inset border border-glass-border rounded-lg px-3.5 py-2.5 text-sm text-foreground placeholder-text-muted focus:outline-none focus:border-primary/60"
            />
            <div className="text-sm text-text-muted mt-1.5">{t("imageUrlHint")}</div>
          </div>
          ...
          <div className="flex items-center justify-end gap-2.5 pt-1">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-primary text-on-accent text-sm font-medium hover:bg-primary-hover transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
            >
