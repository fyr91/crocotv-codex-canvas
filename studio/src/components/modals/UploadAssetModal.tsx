                ...
                >
                                ...
                                {uploadTypes.map((type) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="text-sm text-text-muted mt-1">{type.description}</div>
                                        </button>
                                    );
                                })}
                            </div>
                    ...
                    <div className="mb-6">
                        <label className="block text-sm font-medium text-text-secondary mb-2">
                            {t("assetDescription")} <span className="text-sm text-text-muted">{t("forGeneration")}</span>
                        </label>
                        <textarea
                            value={description}
                    ...
                    {/* Error Message */}
                    {error && (
                        <div className="mb-4 p-3 bg-status-failed-bg border border-status-failed-border rounded-lg text-status-failed-fg text-sm">
                            {error}
                        </div>
                    )}
