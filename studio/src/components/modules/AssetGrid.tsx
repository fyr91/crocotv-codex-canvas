    ...
    return (
        <div className="h-full p-6 overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-display font-medium text-foreground">{ts("generatedAssets")}</h2>
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="glass-button text-sm flex items-center gap-2 text-primary border-primary/30"
                    >
                ...
                {assets.map((asset, i) => (
                    ...
                    >
                        {asset.url ? (
                            ...
                            <div className="w-full h-48 bg-glass flex items-center justify-center text-sm text-text-muted">
                                {ta("generating")}
                            </div>
                        )}
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-overlay via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                            ...
                            <div className="flex items-center justify-between mt-2">
                                <span className="text-sm font-mono bg-hover-bg px-2 py-1 rounded">{asset.type.toUpperCase()}</span>
