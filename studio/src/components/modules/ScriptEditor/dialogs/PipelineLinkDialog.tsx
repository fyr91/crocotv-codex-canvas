    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <div className="w-full max-w-lg rounded-2xl border border-foreground/10 bg-surface shadow-2xl">
              {/* Header */}
              <div className="flex items-center justify-between border-b border-foreground/10 px-6 py-4">
                <h2 className="text-base font-medium text-foreground">{t('dialogs.pipeline.title')}</h2>
                <button
                  type="button"
                  onClick={onClose}
                  ...
                  <button
                    ...
                    className={`flex flex-1 items-center justify-center gap-2 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors ${
                      mode === 'existing'
                        ...
                        : 'bg-elevated text-text-muted hover:text-text-secondary border border-foreground/5'
                    }`}
                  >
                    <Link2 size={14} />
                    ...
                    >
                      ...
                      <div className="relative mb-3">
                        ...
                        <input
                          ...
                          className="w-full rounded-lg border border-foreground/10 bg-elevated pl-9 pr-3 py-2 text-sm text-foreground placeholder:text-text-muted focus:border-primary/50 focus:outline-none transition-colors"
                        />
                      </div>

                      {/* Project list */}
                      <div className="max-h-[240px] overflow-y-auto space-y-1 rounded-lg border border-foreground/5 bg-elevated/30 p-2">
              ...
              {/* Footer */}
              <div className="flex items-center justify-end gap-3 border-t border-foreground/10 px-6 py-4">
                <button
                  type="button"
                  onClick={onClose}
