        ...
        <div className="relative z-10 flex-1 flex flex-col overflow-hidden min-w-0">
                ...
                trailing={(
                    <>
                        ...
                        <button
                            ...
                            disabled={generating}
                            className="inline-flex h-8 items-center gap-1.5 rounded-full bg-primary px-4 py-1.5 font-sans text-sm font-medium text-on-accent shadow-none transition-all duration-fast ease-out-quart hover:bg-primary-hover disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/55"
                        >
            ...
            <div className="flex flex-wrap items-center gap-3 px-4 py-3 shrink-0 sm:px-6">
                <div className="flex items-center gap-3">
                    <span className="font-mono text-sm tracking-[0.04em] text-text-secondary">
                    ...
                    <motion.button
                        ...
                        className="flex items-center gap-1 px-2 py-1 text-sm font-medium text-primary hover:text-primary/80 transition-colors"
                    >
                        ...
                        <div className="rounded-2xl border border-glass-border bg-glass p-8 max-w-lg">
                            ...
                            <div className="mt-5 flex items-center justify-center gap-2">
                                <button
                                    ...
                                    onClick={() => setGenDialogOpen(true)}
                                    disabled={generating}
                                    className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-md bg-primary text-white border border-primary/65 shadow-none hover:bg-primary-hover disabled:opacity-40 transition-colors text-sm font-medium"
                                >
                                ...
                                <button
                                    type="button"
                                    onClick={() => addShot(-1)}
                                    className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-md bg-glass border border-glass-border text-text-secondary hover:text-foreground hover:bg-hover-bg transition-colors text-sm"
                                >
                                    <Plus size={12} />
                                    {t("emptyManualAdd")}
                                </button>
