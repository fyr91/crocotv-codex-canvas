...
export default function VoiceCloneModal({ isOpen, onClose, seriesId, characterName, characterDescription, onCreated }: VoiceCloneModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[110] grid place-items-center bg-overlay backdrop-blur-sm" onClick={handleClose}>
            <div
                className="w-full max-w-lg rounded-2xl border border-glass-border bg-elevated shadow-2xl"
            ...
            >
                ...
                <div className="px-5 py-4 space-y-4">
                    ...
                    >
                        ...
                        {file ? (
                            <div className="flex items-center justify-center gap-2 text-foreground">
                                ...
                                <span className="text-sm truncate max-w-[280px]" title={file.name}>{file.name}</span>
                            ...
                            <div className="flex flex-col items-center gap-2">
                                ...
                                <p className="font-mono text-sm uppercase tracking-[0.14em] text-text-muted">{t("requirements")}</p>
                            </div>
                        )}
                    </div>
                    ...
                    {/* Label input */}
                    <div>
                        <label className="block font-mono text-sm uppercase tracking-[0.18em] text-text-muted mb-1">
                            {t("labelLabel")}
                        </label>
                        <input
                            type="text"
                            ...
                            disabled={inFlight}
                            maxLength={30}
                            className="w-full rounded-md border border-glass-border bg-black/30 px-3 py-2 text-sm text-foreground placeholder:text-text-muted focus:outline-none focus:border-primary/40 disabled:opacity-60"
                        />
                    </div>
