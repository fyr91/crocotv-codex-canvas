          ...
          >
            ...
            <div className="px-6 py-5 border-b border-glass-border flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-sm font-medium text-foreground">{t('assetPicker.title')}</h2>
              </div>
            ...
            <div className="flex-1 overflow-y-auto px-6 pb-2 min-h-0">
              {loading && (
                <div className="flex flex-col items-center justify-center py-16 gap-3">
                  ...
                  <span className="text-sm text-text-muted">{t('assetPicker.loading')}</span>
                </div>
              )}

              {error && !loading && (
                <div className="flex flex-col items-center justify-center py-16 gap-3">
                  <span className="text-sm text-status-failed-fg">{error}</span>
                  <button
                    type="button"
                    onClick={fetchAssets}
            ...
            <div className="flex items-center justify-end gap-2 px-6 py-4 border-t border-glass-border">
              ...
              <button
                ...
                disabled={!selected}
                className={[
                  "inline-flex items-center gap-[7px] px-4 py-2 rounded-full text-sm font-medium transition-all",
                  selected
                    ? "bg-primary text-on-accent shadow-none hover:bg-primary-hover hover:-translate-y-px"
