          ...
          <div className="absolute top-full mt-1 w-full bg-elevated atelier-card border border-border-subtle z-30 max-h-48 overflow-y-auto">
            {options.map((opt) => (
              <div
                ...
                className="px-3 py-2 text-sm flex items-center justify-between hover:bg-hover-bg cursor-pointer"
              >
  ...
  return (
    <div className="flex flex-col gap-[6px]">
      ...
      <div className="flex justify-between px-1">
        <span className="text-sm text-text-muted font-mono">{min}s</span>
        <span className="text-sm text-text-muted font-mono">{max}s</span>
      </div>
    </div>
  );
}
      ...
      {hasAnyAdvanced && (
        <div>
          <button
            ...
            className="inline-flex items-center gap-1 text-sm font-medium text-text-muted hover:text-foreground transition-colors cursor-pointer"
          >
            ...
            <div className="grid grid-cols-2 gap-3 mt-3">
              {supportsSeed && (
                <div className="flex flex-col gap-[6px] atelier-field">
                  <span className="font-mono text-sm uppercase tracking-[0.08em] text-text-muted">Seed</span>
                  <input
                    type="number"
                    placeholder={t('parameters.seedPlaceholder')}
                    className="glass-input w-full text-sm text-foreground font-mono placeholder:text-text-muted bg-surface-inset rounded-xl"
