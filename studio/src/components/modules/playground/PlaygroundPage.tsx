    ...
    <div className="flex h-full flex-col overflow-hidden text-foreground">
      ...
      <header className="flex shrink-0 items-center justify-between border-b border-border-subtle px-7 py-5">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-baseline gap-[10px]">
            <h1 className="font-display text-[2rem] md:text-[2.25rem] font-medium leading-[1.15] tracking-[-0.025em] text-foreground atelier-display">
              {t('header.title')}
            </h1>
          ...
          <p className="font-mono text-text-muted text-sm tracking-[0.06em]">
            {t('header.subtitle')}
          </p>
        </div>
        <div className="flex items-center gap-3">
          <span className="atelier-badge rounded border border-glass-border bg-glass px-2 py-1 text-sm uppercase tracking-[0.18em] text-text-muted">
            {MODE_LABELS[mode]}
          </span>
        </div>
      </header>
      ...
      <div className="flex flex-1 overflow-hidden min-h-0">
        ...
        <aside className="flex w-[420px] shrink-0 flex-col gap-3 overflow-y-auto border-r border-glass-border px-4 py-4 scrollbar-thin">
          {/* Mode */}
          <section className="glass-panel atelier-card rounded-2xl px-5 py-5">
            <div className="mb-3 font-mono text-sm font-medium uppercase tracking-[0.16em] text-text-secondary">
              {t('compose.modeLabel')}
            </div>
            <ModeSelector />
          </section>
          ...
          <section className="glass-panel atelier-card rounded-2xl px-5 py-5 relative z-30">
            <div className="mb-3 font-mono text-sm font-medium uppercase tracking-[0.16em] text-text-secondary">
          ...
          <div className="sticky bottom-0 -mx-4 -mb-4 border-t border-glass-border bg-transparent backdrop-blur-md px-4 pb-4 pt-4">
            <button
              ...
              className={[
                ...
                "font-['Space_Grotesk',sans-serif] text-sm font-medium",
                'bg-primary text-on-accent shadow-none transition-all duration-150 disabled:opacity-40 disabled:shadow-none',
                canGenerate
