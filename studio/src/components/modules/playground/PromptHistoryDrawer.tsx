    ...
    >
      ...
      >
        ...
        <div className="px-6 py-5 border-b border-border-subtle flex items-center justify-between shrink-0">
          <h2 className="font-display atelier-display text-xl font-medium tracking-tight text-foreground">{t('history.title')}</h2>
          <button
            type="button"
            onClick={handleClose}
        ...
        <div className="px-6 py-3 shrink-0">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-surface-inset border border-glass-border rounded-xl pl-9 pr-3 py-2.5 text-sm text-foreground/80 placeholder:text-text-muted outline-none focus:border-primary transition-colors"
            />
          </div>
        </div>
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map((entry, idx) => (
              ...
              >
                ...
                <p className="font-display italic text-sm text-text-secondary leading-relaxed line-clamp-3 mb-2.5">
                  {entry.prompt}
                </p>

                {/* Meta row */}
                <div className="flex items-center gap-1.5 mb-2">
                  <span className="font-mono text-sm bg-primary/15 text-primary rounded px-[6px] py-[2px] uppercase">
