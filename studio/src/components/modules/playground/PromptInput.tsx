  ...
  return (
    <div>
      ...
      <textarea
        ...
        className="w-full min-h-[120px] max-h-[280px] resize-y bg-transparent border-0 rounded-none p-0 text-foreground text-sm leading-[1.65] placeholder-text-muted focus:ring-0"
      />
      ...
      <div className="flex items-center gap-[6px] border-t border-border-subtle pt-2.5 mt-3">
        <button
          ...
          className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-sm font-medium text-text-muted hover:text-foreground hover:bg-hover-bg transition-colors"
        >
          <Copy size={12} />
          {t('prompt.templates')}
        </button>
      ...
      <div
        className="flex items-center gap-[6px] py-[6px] text-sm text-text-muted cursor-pointer hover:text-foreground mt-2"
      ...
      {showNegPrompt && (
        <textarea
          ...
          className="w-full min-h-[60px] resize-y bg-transparent border-0 rounded-none p-0 text-text-secondary text-sm placeholder-text-muted focus:ring-0"
        />
      )}
