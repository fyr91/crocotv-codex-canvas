  ...
  if (history.length === 0) {
    return (
      <div className="flex flex-col flex-1 overflow-hidden min-w-0 items-center justify-center">
        ...
        <p className="text-sm text-text-muted">{t('results.emptyBody')}</p>
      </div>
    );
  }
      ...
      <div className="px-7 py-4 flex items-center justify-between border-b border-border-subtle shrink-0">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-sm bg-elevated text-text-secondary rounded px-[6px] py-[1px]">
          ...
          <div className="flex items-center gap-[2px] bg-surface-inset rounded-full p-1 atelier-pill-tabs">
            {filters.map((f) => (
              <button
                ...
                className={`rounded-full px-4 py-2 text-sm font-medium text-center transition-all cursor-pointer ${
                  activeFilter === f.key
              ...
              if (it.kind === 'divider') {
                return (
                  ...
                  >
                    ...
                    <span className="font-mono text-sm text-text-muted uppercase tracking-wider whitespace-nowrap">
                      {it.label}
                    </span>
                    <div className="flex-1 h-px bg-border-subtle" />
                  </div>
