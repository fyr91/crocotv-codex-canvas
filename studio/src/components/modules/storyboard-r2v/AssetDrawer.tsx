        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        {/* Header */}
                        <div className="flex items-center justify-between px-4 py-3 border-b border-glass-border bg-glass backdrop-blur-xl shrink-0 shadow-none">
                            <h3 className="text-sm font-medium text-foreground">{t("assetLibrary")}</h3>
                            <button
                                onClick={onClose}
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-5">
                            {!hasAnyAssets ? (
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-sm text-text-secondary/60 mt-1">{t("noAssetsHint")}</p>
                                </div>
                            ) : (
                                <>
                                    {/* Characters */}
                                    {characters.length > 0 && (
                                        <div>
                                            <div className="flex items-center gap-1.5 mb-2">
                                                ...
                                                <span className="text-sm font-medium text-text-secondary uppercase tracking-wide">{t("characters")}</span>
                                            </div>
                                                ...
                                                {characters.map((c: any, i: number) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <span className="text-sm text-foreground group-hover:text-primary truncate w-full text-center">{c.name}</span>
                                                        </button>
                                                    );
                                                })}
                                            </div>
                                    ...
                                    {scenes.length > 0 && (
                                        <div>
                                            <div className="flex items-center gap-1.5 mb-2">
                                                <MapPin size={12} className="text-status-completed-fg" />
                                                <span className="text-sm font-medium text-text-secondary uppercase tracking-wide">{t("scenes")}</span>
                                            </div>
                                            <div className="grid grid-cols-2 gap-2">
                                                {scenes.map((s: any) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <span className="text-sm text-foreground group-hover:text-primary truncate w-full text-center">{s.name}</span>
                                                        </button>
                                                    );
                                                })}
                                            </div>
                                    ...
                                    {props.length > 0 && (
                                        <div>
                                            <div className="flex items-center gap-1.5 mb-2">
                                                <Package size={12} className="text-status-processing-fg" />
                                                <span className="text-sm font-medium text-text-secondary uppercase tracking-wide">{t("props")}</span>
                                            </div>
                                            <div className="grid grid-cols-2 gap-2">
                                                {props.map((p: any) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <span className="text-sm text-foreground group-hover:text-primary truncate w-full text-center">{p.name}</span>
                                                        </button>
                                                    );
                                                })}
                                            </div>
