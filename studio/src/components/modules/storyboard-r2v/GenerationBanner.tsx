...
function BannerShell({ children }: { children: React.ReactNode }) {
    return (
        ...
        >
            <div className="flex items-center gap-3 rounded-xl border border-glass-border bg-surface px-4 py-3 shadow-sm">
                {children}
            </div>
        </motion.div>
    );
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3 rounded-xl border border-glass-border bg-surface px-4 py-3 shadow-sm">
                ...
                <span className="text-sm text-text-secondary">
                    <span className="text-status-completed-fg font-medium">
