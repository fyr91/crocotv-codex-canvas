                ...
                {!isLoading && text ? (
                    <div className="flex items-center gap-1">
                        ...
                        <button
                            ...
                            onClick={onApply}
                            title={applyHint}
                            className="btn-tip inline-flex items-center gap-1 rounded bg-primary/90 px-2 py-0.5 font-mono text-chrome font-medium text-white transition-colors duration-fast ease-out-quart hover:bg-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/55"
                        >
