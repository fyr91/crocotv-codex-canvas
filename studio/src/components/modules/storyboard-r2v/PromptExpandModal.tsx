    ...
    const modal = (
        <>
            ...
            <div
                ...
                className="fixed left-1/2 top-1/2 z-[61] flex h-[80vh] w-[min(800px,92vw)] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-xl border border-glass-border bg-surface shadow-2xl motion-safe:animate-[compareModalIn_240ms_cubic-bezier(0.22,1,0.36,1)_both]"
            >
                <header className="flex shrink-0 items-center justify-between gap-3 border-b border-glass-border px-4 py-3">
                    ...
                    <div className="flex items-center gap-1">
                        <button
                            ...
                            className="btn-tip inline-flex h-8 items-center gap-1.5 rounded-md bg-primary px-3 font-display text-display-sm font-medium text-white shadow-none transition-all duration-fast ease-out-quart hover:bg-primary/92 active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/65"
