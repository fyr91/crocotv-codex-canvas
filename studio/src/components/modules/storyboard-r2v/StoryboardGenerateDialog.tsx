                ...
                >
                    ...
                    >
                        ...
                        <div className="px-5 py-4 space-y-4">
                            ...
                            {/* Pre-flight checks */}
                            <section>
                                <h3 className="mb-2 font-mono text-sm uppercase tracking-[0.18em] text-text-muted">
                                    {t("preflightTitle")}
                                </h3>
                                <ul className="space-y-2">
                                    {checks.map((c) => (
                                        ...
                                        >
                                            <span
                                                className={`mt-0.5 inline-flex h-4 w-4 items-center justify-center rounded-full text-sm font-medium ${
                                            ...
                                            <div className="min-w-0 flex-1">
                                                ...
                                                {!c.pass && (
                                                    <p className="text-sm text-text-muted mt-0.5">{c.hint}</p>
                                                )}
                                            </div>
                                        </li>
                                    ))}
                                ...
                                {!allPass && onJumpToScript && (
                                    <button
                                        ...
                                        className="mt-2 inline-flex items-center gap-1 text-sm text-primary hover:text-primary-hover transition-colors"
                                    >
                                        {t("goFixInScript")}
                                        <ArrowRight size={11} />
                                    </button>
