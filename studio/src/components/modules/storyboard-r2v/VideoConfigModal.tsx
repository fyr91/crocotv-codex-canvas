...
function getProviderAccent(modelId: string): string {
    if (modelId.includes("wan") || modelId.includes("wanx")) return "from-primary to-primary";
    if (modelId.includes("kling")) return "from-status-processing-bg to-muted";
    if (modelId.includes("vidu")) return "from-status-completed-bg to-muted";
    if (modelId.includes("pixverse")) return "from-primary to-primary";
    if (modelId.includes("happyhorse")) return " to-primary";
            ...
            {isOpen && (
                ...
                >
                    <motion.div
                        ...
                        className="relative bg-surface border border-glass-border shadow-none rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden"
                    ...
                    >
                        ...
                        <div className="relative flex items-center justify-between px-7 py-5 border-b border-glass-border shrink-0 bg-glass">
                            ...
                            <div className="flex items-center gap-3.5">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-text-muted mt-0.5 tracking-wide font-medium">
                        ...
                        <div className="flex-1 overflow-y-auto px-7 py-7 space-y-9">
                            ...
                            >
                                <div className="flex items-center gap-2.5">
                                    ...
                                    <h3 className="text-sm font-medium text-text-muted uppercase tracking-[0.2em]">
                                        {t("modelSelection")}
                                    </h3>
                                </div>
                                <GroupedModelGrid
                                            ...
                                            <div className="space-y-3 px-1">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span className="text-sm font-medium text-foreground tabular-nums">
                                                        {draft.duration}<span className="text-text-muted text-sm font-medium ml-0.5">s</span>
                                                    </span>
                                                </div>
                                                <div className="relative h-[6px] bg-glass rounded-full">
                                                    ...
                                                    {/* Thumb */}
                                                    <motion.div
                                                        className="absolute top-1/2 -translate-y-1/2 w-[18px] h-[18px] rounded-full bg-white border-2 border-surface shadow-none pointer-events-none"
                                                        animate={{ left: `calc(${pct}% - 9px)` }}
                                                        transition={{ type: "spring", stiffness: 300, damping: 25 }}
                                                    />
                                                </div>
                                                <div className="flex justify-between text-sm text-text-muted font-medium tabular-nums">
                                                    <span>{dc.min}s</span>
                                                    <span>{dc.max}s</span>
                                                </div>
                                            </div>
                                            ...
                                            {dc.options.map((dur) => {
                                                ...
                                                return (
                                                    <motion.button
                                                        ...
                                                        className={`relative flex-1 py-3 text-sm font-medium rounded-xl border transition-all duration-200 overflow-hidden ${
                                                            isActive
                                                                ? "bg-elevated border-foreground/[0.12] text-foreground shadow-none"
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 auto-flow-dense">
                                            ...
                                            {modelParams.resolution && (
                                                <div className="space-y-2.5">
                                                    <label className="block text-sm text-text-muted font-medium tracking-wide">
                                                        {tm("resolutionLabel")}
                                                    </label>
                                            ...
                                            {modelParams.promptExtend && (
                                                <div className="flex items-center justify-between py-1">
                                                    <label className="text-sm text-text-muted font-medium tracking-wide">
                                                        {tm("promptEnhancer")}
                                                    </label>
                                                    <button
                                                    ...
                                                    >
                                                        <motion.div
                                                            className="absolute top-[3px] w-4 h-4 rounded-full bg-white shadow-none"
                                                            animate={{
                                                        ...
                                                        {modelParams.mode.options.map((opt) => {
                                                            ...
                                                            return (
                                                                <motion.button
                                                                    ...
                                                                    className={`flex-1 py-2.5 text-sm font-medium rounded-lg border transition-all duration-200 uppercase tracking-wider ${
                                                                        isActive
                                                        ...
                                                        {(() => {
                                                            ...
                                                            return (
                                                                <>
                                                                    ...
                                                                    />
                                                                    <motion.div
                                                                        className="absolute top-1/2 -translate-y-1/2 w-[16px] h-[16px] rounded-full bg-white border-2 border-surface shadow-none pointer-events-none"
                        ...
                        <div className="flex gap-3 px-7 py-5 border-t border-glass-border shrink-0 bg-glass">
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                onClick={handleApply}
                                className={`relative flex-1 px-4 py-3 rounded-xl bg-gradient-to-r ${activeAccent} text-foreground text-sm font-medium tracking-wide transition-all duration-200 shadow-none hover:shadow-none`}
                            >
                                {t("applySettings")}
                            </motion.button>
                        </div>
