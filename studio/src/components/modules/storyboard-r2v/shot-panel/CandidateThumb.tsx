    ...
    return (
        <div className="flex w-full flex-col gap-1">
            <div
                ...
                className={`group relative aspect-video overflow-hidden rounded-xl border bg-black/40 shadow-sm transition-all duration-base ease-out-quart hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-1 focus-visible:ring-offset-black ${
                    isCompareSelected
                        ? "border-status-starred-border ring-2 ring-status-starred-bg"
                        : isActive
                            ? "border-primary ring-1 ring-primary/40 shadow-none"
                            : isCompleted
            ...
            >
                    ...
                    >
                        <span
                            ...
                            className={`grid h-[22px] w-[22px] place-items-center rounded-full border transition-all duration-fast ease-out-quart active:scale-90 ${
                                isActive
                                    ? "border-primary bg-primary/85 text-white shadow-none"
                ...
                >
                    <span
                        ...
                        className={`grid h-[22px] w-[22px] place-items-center rounded-full border transition-all duration-fast ease-out-quart active:scale-90 ${
                            task.is_starred
                                ? "border-status-starred-border bg-status-starred-bg text-status-starred-fg shadow-none"
