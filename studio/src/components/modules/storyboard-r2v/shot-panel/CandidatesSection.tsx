        ...
        >
            {totalCount === 0 ? (
                <div className="flex flex-col items-center gap-2 px-3 py-5">
                    <div className="font-display text-display-sm font-medium tracking-tight text-foreground">
                        {t("noCandidatesTitle")}
                    </div>
                ...
                <div className="space-y-2">
                    {/* Compare callout — promoted to display tier when
                        ≥2 selected. */}
                    {compareCount >= 2 ? (
                        <div className="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-status-starred-border bg-status-starred-bg px-3 py-2 shadow-none sm:gap-3">
                            <span className="font-display text-display-sm font-medium tracking-tight text-status-starred-fg">
...
function BatchBlock({
    ...
    return (
        <div className="rounded-xl border border-glass-border bg-black/15">
