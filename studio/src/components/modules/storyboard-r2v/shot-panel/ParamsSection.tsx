    ...
    return (
        <SectionShell
            ...
            trailing={inFlightCount > 0 ? (
                <span className="rounded-full border border-status-processing-border bg-status-processing-bg px-1.5 py-0.5 text-sm font-medium leading-none text-status-processing-fg">
                ...
                <ParamRow label="Model">
                    <div className="relative">
                        <button
                            ...
                            className="inline-flex min-h-[28px] items-center gap-2 rounded-xl border border-glass-border bg-surface-inset px-3 py-1.5 font-mono text-sm font-medium text-foreground transition-colors duration-fast ease-out-quart hover:border-foreground/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/55"
                        >
                        ...
                        {modelOpen && menuPos && createPortal(
                            <>
                                ...
                                <div
                                    className="fixed z-[70] max-h-60 min-w-[12rem] overflow-y-auto rounded-xl border border-border-subtle bg-elevated p-1 shadow-md"
                ...
                {hasAdvanced ? (
                    <div className="pt-1 pl-4">
                        <button
                            ...
                            className="group inline-flex items-center gap-1.5 rounded-md py-1 font-mono text-sm font-medium text-primary transition-colors duration-fast ease-out-quart hover:text-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/55"
                        >
                            <ChevronRight
                                size={12}
                                strokeWidth={2}
                            ...
                            <span className="ml-0.5 rounded-md bg-primary/10 px-1.5 py-0.5 text-sm text-primary">
...
function ParamRow({ label, children }: { label: string; children: React.ReactNode }) {
    ...
    return (
        <div className="flex flex-col items-start gap-1.5 sm:flex-row sm:gap-4">
            <span className="font-mono text-sm font-medium uppercase tracking-[0.1em] text-text-muted w-20 shrink-0 pt-1.5">
                {label}
            </span>
            ...
            {options.map((opt) => {
                ...
                return (
                    <button
                        ...
                        aria-pressed={active}
                        className={`min-h-[28px] rounded-full border px-2.5 py-1 font-mono text-sm font-medium transition-colors duration-fast ease-out-quart focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/55 ${
                            active
