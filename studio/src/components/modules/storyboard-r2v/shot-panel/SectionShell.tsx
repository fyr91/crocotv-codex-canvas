            ...
            {headerOverride ?? (
                <div className="flex items-center gap-2 px-3 mb-3">
                    ...
                    >
                        ...
                        <span className="font-mono text-sm font-medium uppercase tracking-[0.16em] text-text-secondary">
                            {title}
                        </span>
                        {subtitle ? (
                            <span className="truncate font-mono text-sm tracking-tight text-text-muted">
                                {subtitle}
                            </span>
                        ) : null}
                    </button>
