...
export default function ShotPanel({ children }: ShotPanelProps) {
    ...
    return (
        <div className="relative ml-2 mr-1 mt-1.5 md:ml-5">
            ...
            />
            <div className="rounded-lg border border-glass-border bg-black/30 shadow-none backdrop-blur-[2px] motion-safe:animate-[shotPanelIn_220ms_cubic-bezier(0.22,1,0.36,1)_both]">
                {children}
            </div>
        </div>
    );
