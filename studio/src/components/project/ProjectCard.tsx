        ...
        >
            ...
            <div className="relative aspect-[16/10] overflow-hidden bg-surface-inset">
                ...
                <div className="absolute top-3 left-3 z-[2]">
                    <span className={`atelier-badge inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-sm font-mono font-medium uppercase tracking-wider ${badge.cls}`}>
                ...
                <div className="absolute bottom-3 left-4 right-4 z-[2]">
                    <h3 className="font-display atelier-display text-xl font-medium leading-7 tracking-tight text-white truncate">
                        {project.title}
                    </h3>
                    <div className="font-mono text-sm uppercase tracking-wider mt-1 truncate text-foreground/75">
            ...
            <div className="flex items-center justify-between px-4 py-3.5">
                <div className="flex flex-col gap-1.5 min-w-0">
                    <span className="font-mono text-sm uppercase tracking-wider text-text-muted truncate">
                ...
                <div className="relative" ref={menuWrapRef} onClick={(e) => e.stopPropagation()}>
                    ...
                    {menuOpen ? (
                        <div
                            role="menu"
                            aria-label={t("moreActions")}
                            className="absolute right-0 bottom-full z-20 mb-2 w-40 overflow-hidden rounded-md border border-glass-border bg-surface/96 shadow-lg backdrop-blur-md"
                        >
                            <button
                                type="button"
                                role="menuitem"
                            ...
                            <button
                                ...
                                className="flex w-full items-center gap-2.5 px-3 py-2.5 text-left font-sans text-body-sm text-foreground transition-colors hover:bg-status-failed-bg hover:text-status-failed-fg focus-visible:outline-none focus-visible:bg-status-failed-bg focus-visible:text-status-failed-fg"
                            >
