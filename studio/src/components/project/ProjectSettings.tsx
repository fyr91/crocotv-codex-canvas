                    ...
                    >
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-glass-border">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="text-xl font-medium text-foreground">{t("styleSettings")}</h2>
                                    <p className="text-sm text-text-muted">{t("styleSettingsSub")}</p>
                                </div>
                            </div>
                            <button
                                onClick={onClose}
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
                            ...
                            <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 flex gap-3">
                                ...
                                <div className="text-sm text-foreground">
                                    <p className="font-medium mb-1">{t("globalStyleInfo")}</p>
                            ...
                            {selectedStyle && (
                                <div className="bg-glass border border-glass-border rounded-lg p-4">
                                    <p className="text-sm text-text-muted mb-2">{t("styleApplied")}</p>
