                ...
                >
                    ...
                    <div className="p-6 border-b border-glass-border flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl font-medium text-foreground">{t("promptConfig")}</h2>
                                <p className="text-sm text-text-secondary">{t("promptConfigSub")}</p>
                            </div>
                        </div>
                        ...
                        {isLoading ? (
                            ...
                            <>
                                ...
                                <div className="space-y-2">
                                    <div>
                                        <h3 className="text-sm font-medium text-foreground">Polish 模型</h3>
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-surface border border-glass-border rounded-lg px-3 py-2 text-sm text-foreground focus:outline-none focus:border-primary/50"
                                    >
                                    ...
                                    <div key={section.key} className="space-y-2">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <button
                                                ...
                                                className="text-sm text-text-secondary hover:text-foreground flex items-center gap-1 px-2 py-1 rounded hover:bg-hover-bg transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                                            >
                                        ...
                                        <textarea
                                            ...
                                            className="w-full h-32 bg-surface border border-glass-border rounded-lg p-3 text-sm text-foreground resize-y focus:outline-none focus:border-primary/50 font-mono placeholder-text-muted"
                                        />
                                        ...
                                        {defaults && (
                                            <div>
                                                <button
                                                    ...
                                                    className="text-sm text-text-muted hover:text-foreground flex items-center gap-1 transition-colors"
                                                >
                                                    {expandedDefault === section.key ? <ChevronDown size={10} /> : <ChevronRight size={10} />}
                                                    {t("viewDefault")}
                                                </button>
                                                {expandedDefault === section.key && (
                                                    <pre className="mt-2 bg-surface border border-border-subtle rounded-lg p-3 text-sm text-text-muted overflow-x-auto max-h-48 overflow-y-auto whitespace-pre-wrap font-mono">{defaults[section.key]}</pre>
                                                )}
                                            </div>
                                        )}
                    ...
                    <div className="p-6 border-t border-glass-border flex justify-end gap-3">
                        ...
                        <button
                            ...
                            className="px-6 py-2 text-sm font-medium bg-primary hover:bg-primary text-foreground rounded-lg transition-colors disabled:opacity-50 flex items-center gap-2"
                        >
