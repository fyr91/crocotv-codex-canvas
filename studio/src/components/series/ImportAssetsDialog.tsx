                    ...
                    <div className="p-5 border-b border-glass-border flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="rounded-lg bg-muted p-2">
                                <Download size={20} className="text-status-completed-fg" />
                            </div>
                            <div>
                                <h2 className="text-xl font-medium text-foreground">{t("importAssets")}</h2>
                                <p className="text-sm text-text-secondary">{t("importAssetsDesc")}</p>
                            </div>
                        </div>
                                            ...
                                            >
                                                <div className="flex items-center justify-between">
                                                    <div>
                                                        ...
                                                        {s.description && (
                                                            <p className="text-sm text-text-secondary mt-0.5 line-clamp-1">{s.description}</p>
                                                        )}
                                ...
                                <div className="flex border-b border-glass-border">
                                    {tabs.map((tab) => (
                                        ...
                                        >
                                            <tab.icon size={14} />
                                            {tab.label}
                                            <span className="text-sm bg-hover-bg px-1.5 py-0.5 rounded">{tab.count}</span>
                                        </button>
                                    ))}
                                </div>
                                ...
                                <div className="p-5 grid grid-cols-2 sm:grid-cols-3 gap-3 overflow-y-auto max-h-[45vh]">
                                    {getSourceAssets().length === 0 ? (
                                        <div className="col-span-full flex flex-col items-center justify-center py-8 text-text-secondary">
                                            ...
                                            <p className="text-sm">{t("noAssetsType")}</p>
                                        </div>
                                    ) : (
                                        getSourceAssets().map((asset) => (
                                            ...
                                            >
                                                ...
                                                <div className="p-2">
                                                    ...
                                                    {asset.description && (
                                                        <p className="text-sm text-text-secondary mt-0.5 line-clamp-1">{asset.description}</p>
                                                    )}
                                                </div>
                                            </button>
                                        ))
