                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-display font-medium text-foreground">{t("importTitle")}</h2>
                            <button
                                onClick={handleClose}
                        ...
                        {/* Error Message */}
                        {error && (
                            <div className="mb-4 px-4 py-3 rounded-lg bg-status-failed-bg border border-status-failed-border text-status-failed-fg text-sm">
                                {error}
                            </div>
                        )}
                                ...
                                <div className="space-y-4">
                                    ...
                                    >
                                        ...
                                        {file ? (
                                            <div className="flex items-center justify-center gap-3">
                                                <FileText size={24} className="text-status-completed-fg" />
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-text-secondary mb-2">
                                            {t("seriesTitle")} <span className="text-status-failed-fg">*</span>
                                        </label>
                                        <input
                                            type="text"
                                            value={seriesTitle}
                            ...
                            {step === 3 && createdResult && (
                                <div className="flex flex-col items-center justify-center py-8 space-y-6">
                                    <div className="w-16 h-16 rounded-full bg-status-completed-bg flex items-center justify-center">
                                        <Check size={32} className="text-status-completed-fg" />
                                    </div>
                                    <div className="text-center">
                                        <h3 className="text-xl font-medium text-foreground mb-2">{t("createSuccess")}</h3>
