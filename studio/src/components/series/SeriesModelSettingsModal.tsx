                ...
                >
                    ...
                    <div className="flex items-center justify-between p-5 border-b border-glass-border">
                        <div className="flex items-center gap-3">
                            <div className="p-2 bg-gradient-to-br from-primary/20 to-primary/20 rounded-lg">
                                <Settings size={20} className="text-primary" />
                            </div>
                            <div>
                                <h2 className="text-xl font-medium text-foreground">{t("seriesGenSettings")}</h2>
                                <p className="text-sm text-text-secondary">{t("seriesGenSettingsDesc")}</p>
                            </div>
                        </div>
                            ...
                            <>
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-sm text-text-secondary">{t("model")}</label>
                                        <GroupedModelGrid
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-sm text-text-secondary">{t("aspectRatio")}</label>
                                        <div className="grid grid-cols-3 gap-2">
                                            {ASPECT_RATIOS.map((ratio) => (
                                                ...
                                                >
                                                    <span className="text-sm font-medium text-foreground">{ratio.name}</span>
                                                    <span className="text-sm text-text-secondary">{ratio.description}</span>
                                                </button>
                                            ))}
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-sm text-text-secondary">{t("motionFollowsAR")}</p>
                    ...
                    <div className="flex justify-end gap-3 p-5 border-t border-glass-border bg-surface">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary to-primary hover:from-primary hover:to-primary text-foreground text-sm font-medium rounded-lg transition-all disabled:opacity-50"
                        >
                            {isSaving ? (
                                <>
