                ...
                >
                    ...
                    <div className="p-6 border-b border-glass-border flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl font-medium text-foreground">{t("seriesPromptConfig")}</h2>
                                <p className="text-sm text-text-secondary">{t("seriesPromptConfigSub")}</p>
                            </div>
                        </div>
                        ...
                        {isLoading ? (
                            ...
                            <>
                                ...
                                <div className="space-y-2">
                                    <div>
                                        <h3 className="text-sm font-medium text-foreground">{t("polishModelTitle")}</h3>
                                        ...
                                        {defaults && (
                                            <div>
                                                <button
                                                    ...
                                                    className="text-sm text-text-secondary hover:text-foreground flex items-center gap-1 transition-colors"
                                                >
                                                    {expandedDefault === section.key ? <ChevronDown size={10} /> : <ChevronRight size={10} />}
                                                    {t("viewDefault")}
                                                </button>
                                                {expandedDefault === section.key && (
                                                    <pre className="mt-2 bg-surface border border-border-subtle rounded-lg p-3 text-sm text-text-secondary overflow-x-auto max-h-48 overflow-y-auto whitespace-pre-wrap font-mono">{defaults[section.key]}</pre>
                                                )}
                                            </div>
                                        )}
