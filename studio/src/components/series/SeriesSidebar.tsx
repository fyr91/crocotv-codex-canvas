  ...
  return (
    ...
    >
        ...
        {(() => {
          ...
          return (
            ...
            >
              ...
              <span
                className={clsx(
                  "text-sm px-1.5 py-0.5 rounded-md font-mono uppercase tracking-wider",
                  hasStyle
                    ? isActive
        ...
        {ASSET_TABS.map(({ tab, labelKey, icon: Icon }) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={clsx(
                  "text-sm px-1.5 py-0.5 rounded-md font-mono",
                  isActive
                    ? "bg-primary/20 text-primary"
                    : "bg-glass text-text-secondary"
                )}
          ...
          <AnimatePresence mode="wait">
            {showAddEpisode ? (
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 bg-primary hover:bg-primary/90 text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-colors disabled:opacity-50 active:scale-[0.97]"
                    >
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg text-text-secondary hover:text-foreground hover:bg-hover-bg transition-colors text-sm active:scale-[0.97]"
                    >
                      {tc("cancel")}
                    </button>
                  </div>
              ...
              <motion.button
                ...
                className="w-full flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg text-text-secondary hover:text-foreground hover:bg-hover-bg transition-colors text-sm border border-dashed border-glass-border hover:border-glass-border active:scale-[0.97]"
              >
                <Plus size={14} />
                {t("addEpisode")}
              </motion.button>
      ...
      <div className="border-t border-glass-border p-3 space-y-1">
        ...
        >
          <Download size={16} className="group-hover:text-status-completed-fg transition-colors" />
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-text-secondary hover:text-foreground hover:bg-hover-bg transition-colors group"
        >
          <MessageSquareCode size={16} className="group-hover:text-primary transition-colors" />
