...
export default function UpdateChecker() {
  ...
  return (
    <div className="flex items-center justify-between gap-3 flex-wrap py-2.5 border-t border-glass-border text-sm">
      ...
      <div className="flex items-center gap-2.5 flex-wrap justify-end">
        ...
        <span
          role="status"
          aria-live="polite"
          className={`inline-flex items-center gap-1.5 font-mono text-sm ${statusColor}`}
        >
          {status === "latest" && (
            <>
              <Check size={13} />
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-glass-border text-primary hover:border-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium"
        >
          {checking ? (
