    ...
    return (
        ...
        >
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-0">
                <span
                    className="truncate font-sans text-sm font-medium leading-tight text-foreground"
                ...
                {subtitle ? (
                    <span
                        className="truncate font-sans text-sm font-normal leading-tight text-text-muted"
                        style={{ letterSpacing: 0 }}
                    >
                        {subtitle}
                    </span>
