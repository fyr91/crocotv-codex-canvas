...
const canvasWheelIgnoreSelector = "textarea,[contenteditable='true'],[data-canvas-scroll],[data-canvas-no-zoom],.ant-modal,.ant-popover,.ant-dropdown,.ant-select-dropdown,.ant-picker-dropdown";

export function CrocoCanvas({ containerRef, viewport, backgroundMode = "lines", onViewportChange, onCanvasMouseDown, onCanvasDeselect, onContextMenu, onDrop, viewportOverlay, children }: CrocoCanvasProps) {
    ...
    const handleWheel = (event: React.WheelEvent<HTMLDivElement>) => {
        ...
        if (target?.closest(canvasWheelIgnoreSelector)) return;
