...
type ProviderAvailability = Partial<Record<"codingPlan" | "volcengine" | "bigmodel" | "runware" | "speech" | "gpu" | "h3" | "suno", boolean>>;
...
export function modelsForProviderAvailability(models: ProviderCatalogModel[], providers: ProviderAvailability) {
    ...
    return models.filter((model) => {
        if (model.provider_id === "coding_plan") return providers.codingPlan;
